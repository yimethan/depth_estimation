...
def conv3x3(in_dim, out_dim, stride=2, groups=1, dilation=1):
    return nn.Conv2d(in_dim, out_dim, kernel_size=3, stride=stride, padding=dilation, groups=groups, bias=False)

def conv1x1(in_dim, out_dim, stride=2):
